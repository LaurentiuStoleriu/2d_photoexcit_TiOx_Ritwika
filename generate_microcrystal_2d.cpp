...
int main()
{
    ...
    FILE *fp;
    //fp = fopen("/home/ritwika/data/1.hc4250_Oct'20/results/systems/200x200_r02_d06_Cryst10x10.dat", "w");
    fp = fopen("E:\\Stoleriu\\C\\special\\3d\\generare\\2022\\TiOX\\200x200_r02_d06_Cryst10x10.dat", "w");
